        ...
        <div className="lp-features__grid">
          <div className="lp-feature lp-feature--hero">
            ...
            <p className="lp-feature__desc">
              ...
              Up to 18 minutes with automatic wrap-up.
            </p>
        ...
        <div className="lp-how__steps">
          ...
          <div className="lp-step">
            ...
            <div className="lp-step__content">
              ...
              <p className="lp-step__desc">
                The AI starts by introducing the role and asks tailored questions over up to 18 minutes. Your video is recorded locally. Proctoring runs in the background.
              </p>
            </div>
          </div>
          <div className="lp-step__connector" />
...
{ q: "How realistic are the AI interviews?", a: "Very. We use Gemini AI for real-time bidirectional voice conversations. The AI listens, understands context, asks follow-ups, and responds naturally. It asks questions over up to 18 minutes with automatic wrap-up — just like a real interview panel." },
